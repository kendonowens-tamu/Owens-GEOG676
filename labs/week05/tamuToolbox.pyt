...
class GarageBuffer(object):
    ...
    def execute(self, parameters, messages):
        ...
        arcpy.Project_management(garages,GDB+'\GaragePointsProjection',spatial_ref)

        arcpy.Buffer_analysis(GDB + "/GaragePointsProjection", garage_buffer, parameters[0].valueAsText+" Meters")
        arcpy.Intersect_analysis([garage_buffer, buildings], GDB + "/Intersection", "ALL")
        arcpy.TableToTable_conversion(GDB+"/Intersection",GDB,parameters[4].valueAsText+"_table.csv")
        return