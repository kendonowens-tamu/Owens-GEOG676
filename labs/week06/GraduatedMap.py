            ...
            if layer.isFeatureLayer:
                ...
                if hasattr(symbology,'renderer'):
                    if layer.name == parameters[1].valueAsText:
                        ...
                        symbology.renderer.classificationsField = parameters[2].valueAsText #field that the cloropleth is created from
                        symbology.renderer.breakCount = 5 #classes we'll have for the map
                        symbology.renderer.colorRamp = project.listColorRamps('Oranges (5Classes)')[0]
